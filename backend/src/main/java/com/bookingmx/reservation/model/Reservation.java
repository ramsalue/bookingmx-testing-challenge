...
public class Reservation {
    ...
    public double calculateTotalPrice() {
        ...
        return numberOfNights * roomType.getBasePrice();
    }
    ...
    public void setCheckInDate(LocalDate checkInDate) throws InvalidReservationException {
        ...
        this.checkInDate = checkInDate;
        // Recalculate price if checkout date exists
        if (this.checkOutDate != null && this.roomType != null) {
            this.totalPrice = calculateTotalPrice();
        }
    }
    ...
    public void setCheckOutDate(LocalDate checkOutDate) throws InvalidReservationException {
        ...
        this.checkOutDate = checkOutDate;
        // Recalculate price if checkin date exists
        if (this.checkInDate != null && this.roomType != null) {
            this.totalPrice = calculateTotalPrice();
        }
    }
